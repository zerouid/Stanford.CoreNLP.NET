...
{
	/// <summary>A quadruple of ordered objects.</summary>
	...
	/// <?/>
	[System.Serializable]
	public class Quadruple<T1, T2, T3, T4> : IComparable<Edu.Stanford.Nlp.Util.Quadruple<T1, T2, T3, T4>>, IPrettyLoggable
	{
		...
		/// </remarks>
		public static Edu.Stanford.Nlp.Util.Quadruple<T1, T2, T3, T4> MakeQuadruple<T1, T2, T3, T4>(T1 t1, T2 t2, T3 t3, T4 t4)
		{
			return new Edu.Stanford.Nlp.Util.Quadruple<T1, T2, T3, T4>(t1, t2, t3, t4);
		}
