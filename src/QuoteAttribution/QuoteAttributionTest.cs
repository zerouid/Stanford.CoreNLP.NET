...
namespace Edu.Stanford.Nlp.Quoteattribution
{
	...
	public class QuoteAttributionTest
	{
		...
		/// <summary>Usage: java QuoteAttributionTest familywordsfile animatefile gendernamesfile charactersfile modelfile</summary>
		/// <param name="args"/>
		/// <exception cref="System.IO.IOException"/>
		/// <exception cref="System.TypeLoadException"/>
		public static void Main(string[] args)
		{
			if (args.Length != 5)
			{
				System.Console.Out.WriteLine("Usage: java QuoteAttributionTest familywordsfile animatefile gendernamesfile charactersfile modelfile");
