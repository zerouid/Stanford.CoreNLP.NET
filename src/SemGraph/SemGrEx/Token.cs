...
namespace Edu.Stanford.Nlp.Semgraph.Semgrex
{
	...
	internal class Token
	{
		...
		/// this field.
		/// </remarks>
		public Edu.Stanford.Nlp.Semgraph.Semgrex.Token next;
		...
		/// </remarks>
		public Edu.Stanford.Nlp.Semgraph.Semgrex.Token specialToken;
		...
		/// </remarks>
		public static Edu.Stanford.Nlp.Semgraph.Semgrex.Token NewToken(int ofKind, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Edu.Stanford.Nlp.Semgraph.Semgrex.Token(ofKind, image);
				}
			}
		}

		public static Edu.Stanford.Nlp.Semgraph.Semgrex.Token NewToken(int ofKind)
		{
