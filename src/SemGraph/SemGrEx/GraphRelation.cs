...
namespace Edu.Stanford.Nlp.Semgraph.Semgrex
{
	...
	internal abstract class GraphRelation
	{
		...
		{
			private const long serialVersionUID = 4710135995247390313L;
		...
		{
			private const long serialVersionUID = 5259713498453659251L;
		...
		{
			private const long serialVersionUID = -3088857488269777611L;
