...
{
	/// <summary>An Object to double map used for keeping weights or counts for objects.</summary>
	/// <remarks>
	...
	/// <author>cer</author>
	/// <author>pado</author>
	public interface ICounter<E> : IPrettyLoggable
	{
		/// <summary>Returns a factory that can create new instances of this kind of Counter.</summary>
		/// <returns>A factory that can create new instances of this kind of Counter.</returns>
		IFactory<ICounter<E>> GetFactory();

		/// <summary>Sets the default return value.</summary>
		/// <remarks>
		...
		/// </remarks>
		/// <param name="rv">The default value</param>
		void SetDefaultReturnValue(double rv);

		/// <summary>Returns the default return value.</summary>
		/// <returns>The default return value.</returns>
		double DefaultReturnValue();

		/// <summary>Returns the count for this key as a double.</summary>
		/// <remarks>
		...
		/// <summary>Sets the count for the given key to be the given value.</summary>
		/// <remarks>
		...
		/// <see cref="ICounter{E}.IncrementCount(object, double)"/>
		/// .
		/// </remarks>
		/// <param name="key">The key</param>
		...
		/// <summary>Increments the count for the given key by the given value.</summary>
		/// <remarks>
		...
		/// <see cref="ICounter{E}.IncrementCount(object)"/>
		/// .
		/// To set a count to a specific value instead of incrementing it, use
		/// <see cref="ICounter{E}.SetCount(object, double)"/>
		/// .
		/// </remarks>
		/// <param name="key">The key to increment</param>
		/// <param name="value">The amount to increment it by</param>
		/// <returns>The value associated with they key, post-increment.</returns>
		double IncrementCount(E key, double value);

		/// <summary>Increments the count for this key by 1.0.</summary>
		/// <remarks>
		...
		/// .
		/// </remarks>
		/// <param name="key">The key to increment by 1.0</param>
		/// <returns>The value associated with they key, post-increment.</returns>
		double IncrementCount(E key);

		/// <summary>Decrements the count for this key by the given value.</summary>
		/// <remarks>
		...
		/// <see cref="ICounter{E}.DecrementCount(object)"/>
		/// .
		...
		/// <param name="value">The amount to decrement it by</param>
		/// <returns>The value associated with they key, post-decrement.</returns>
		double DecrementCount(E key, double value);

		/// <summary>Decrements the count for this key by 1.0.</summary>
		/// <remarks>
		...
		/// <see cref="ICounter{E}.DecrementCount(object, double)"/>
		/// .
		/// To set a count to a specific value instead of decrementing it, use
		/// <see cref="ICounter{E}.SetCount(object, double)"/>
		/// .
		/// </remarks>
		/// <param name="key">The key to decrement by 1.0</param>
		/// <returns>The value of associated with they key, post-decrement.</returns>
		...
		/// </remarks>
		/// <param name="key">The key to increment</param>
		/// <param name="value">The amount to increment it by, in log space</param>
		/// <returns>The value associated with they key, post-increment, in log space</returns>
		...
		/// <summary>Removes the given key and its associated value from this Counter.</summary>
		/// <remarks>
		...
		/// <summary>Returns whether a Counter contains a key.</summary>
		/// <param name="key">The key</param>
		/// <returns>true iff key is a key in this Counter.</returns>
		bool ContainsKey(E key);

		/// <summary>Returns the Set of keys in this counter.</summary>
		/// <returns>The Set of keys in this counter.</returns>
		ICollection<E> KeySet();

		/// <summary>Returns a copy of the values currently in this counter.</summary>
		/// <remarks>
		...
		/// </remarks>
		/// <returns>A copy of the values currently in this counter.</returns>
		ICollection<double> Values();

		/// <summary>Returns a view of the entries in this counter.</summary>
		/// <remarks>
		/// Returns a view of the entries in this counter.  The values
		/// can be safely modified with setValue().
		/// </remarks>
		/// <returns>A view of the entries in this counter</returns>
		ICollection<KeyValuePair<E, double>> EntrySet();

		/// <summary>Removes all entries from the counter.</summary>
		void Clear();

		/// <summary>Returns the number of entries stored in this counter.</summary>
		/// <returns>The number of entries in this counter.</returns>
		int Size();
		...
		/// operation is cheap.)
		/// </remarks>
		/// <returns>The total (arithmetic sum) of all counts in this counter.</returns>
		double TotalCount();
	}
}
