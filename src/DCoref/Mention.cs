...
namespace Edu.Stanford.Nlp.Dcoref
{
	...
	[System.Serializable]
	public class Mention : ICoreAnnotation<Edu.Stanford.Nlp.Dcoref.Mention>
	{
		...
		public Mention(int mentionID, int startIndex, int endIndex, SemanticGraph dependency, IList<CoreLabel> mentionSpan)
		{
			this.mentionID = mentionID;
			this.startIndex = startIndex;
			this.endIndex = endIndex;
		...
		public Mention(int mentionID, int startIndex, int endIndex, SemanticGraph dependency, IList<CoreLabel> mentionSpan, Tree mentionTree)
		{
			this.mentionID = mentionID;
			this.startIndex = startIndex;
			this.endIndex = endIndex;
		...
		public ICollection<Edu.Stanford.Nlp.Dcoref.Mention> appositions = null;

		public ICollection<Edu.Stanford.Nlp.Dcoref.Mention> predicateNominatives = null;

		public ICollection<Edu.Stanford.Nlp.Dcoref.Mention> relativePronouns = null;

		/// <summary>Set of other mentions in the same sentence that below to this list</summary>
		public ICollection<Edu.Stanford.Nlp.Dcoref.Mention> listMembers = null;

		/// <summary>Set of other mentions in the same sentence that I am a member of</summary>
		public ICollection<Edu.Stanford.Nlp.Dcoref.Mention> belongToLists = null;
		...
		{
			return typeof(Edu.Stanford.Nlp.Dcoref.Mention);
		}
		...
		public virtual string LowercaseNormalizedSpanString()
		{
			...
			if (lowercaseNormalizedSpanString == null)
			{
				...
				lowercaseNormalizedSpanString = spanString.ToLower();
			}
			//    }
		...
		public virtual void Process(Dictionaries dict, Semantics semantics, MentionExtractor mentionExtractor)
		{
			SetHeadString();
			SetType(dict);
			SetNERString();
			...
			if (semantics != null)
			{
				SetSemantics(dict, semantics, mentionExtractor);
			}
		}

		/// <exception cref="System.Exception"/>
		public virtual void Process(Dictionaries dict, Semantics semantics, MentionExtractor mentionExtractor, LogisticClassifier<string, string> singletonPredictor)
		{
		...
		/// </summary>
		protected internal virtual List<string> GetSingletonFeatures(Dictionaries dict)
		{
		...
		{
			utter = headWord.Get(typeof(CoreAnnotations.UtteranceAnnotation));
		...
		public virtual bool IsListMemberOf(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			if (this.Equals(m))
			{
				return false;
		...
		public virtual void AddListMember(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			if (listMembers == null)
			{
		...
		public virtual void AddBelongsToList(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		public virtual bool IsMemberOfSameList(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			ICollection<Edu.Stanford.Nlp.Dcoref.Mention> l1 = belongToLists;
			ICollection<Edu.Stanford.Nlp.Dcoref.Mention> l2 = m.belongToLists;
		...
		private void SetType(Dictionaries dict)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						if (headWord.Get(typeof(CoreAnnotations.PartOfSpeechAnnotation)).StartsWith("PRP") || (originalSpan.Count == 1 && headWord.Get(typeof(CoreAnnotations.NamedEntityTagAnnotation)).Equals("O") && (dict.allPronouns.Contains(headString) || dict.relativePronouns
							.Contains(headString))))
						{
							mentionType = Dictionaries.MentionType.Pronominal;
						}
		...
		protected internal virtual void SetNumber(Dictionaries dict)
		{
			...
			if (mentionType != Dictionaries.MentionType.Pronominal)
			{
				...
				{
					//        Tree t = m.getMatch();
					if (this.mentionSubTree == m.GetNode("tmp") && this.SpanToString().ToLower().Contains(" and "))
					{
						number = Dictionaries.Number.Plural;
					}
				}
		...
		public virtual bool SameSentence(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		protected internal virtual bool HeadsAgree(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		public virtual bool NumbersAgree(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			return NumbersAgree(m, false);
		}

		private bool NumbersAgree(Edu.Stanford.Nlp.Dcoref.Mention m, bool strict)
		{
			if (strict)
			{
		...
		public virtual bool GendersAgree(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			return GendersAgree(m, false);
		}

		public virtual bool GendersAgree(Edu.Stanford.Nlp.Dcoref.Mention m, bool strict)
		{
			if (strict)
			{
		...
		public virtual bool AnimaciesAgree(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			return AnimaciesAgree(m, false);
		}

		public virtual bool AnimaciesAgree(Edu.Stanford.Nlp.Dcoref.Mention m, bool strict)
		{
			if (strict)
			{
		...
		public virtual bool EntityTypesAgree(Edu.Stanford.Nlp.Dcoref.Mention m, Dictionaries dict)
		{
			return EntityTypesAgree(m, dict, false);
		}

		public virtual bool EntityTypesAgree(Edu.Stanford.Nlp.Dcoref.Mention m, Dictionaries dict, bool strict)
		{
			if (strict)
			{
		...
		public virtual bool IncludedIn(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			...
			foreach (Tree t in m.mentionSubTree.SubTrees())
			{
				if (t == mentionSubTree)
				{
					return true;
		...
		public virtual bool AttributesAgree(Edu.Stanford.Nlp.Dcoref.Mention potentialAntecedent, Dictionaries dict)
		{
		...
		public virtual void AddApposition(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			if (appositions == null)
			{
		...
		public virtual bool IsApposition(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		public virtual void AddPredicateNominatives(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		public virtual bool IsPredicateNominatives(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		public virtual void AddRelativePronoun(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		public virtual bool AppearEarlierThan(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
		...
		private static Pair<IndexedWord, string> FindDependentVerb(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			if (m.dependency.GetRoots().Count == 0)
			{
		...
		public virtual bool InsideIn(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			return this.sentNum == m.sentNum && m.startIndex <= this.startIndex && this.endIndex <= m.endIndex;
		}

		public virtual bool MoreRepresentativeThan(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			if (m == null)
			{
				return true;
		...
		public virtual List<List<IndexedWord>> GetPremodifiers()
		{
			...
			foreach (Pair<GrammaticalRelation, IndexedWord> child in dependency.ChildPairs(headIndexedWord))
			{
				...
				{
					List<IndexedWord> phrase = new List<IndexedWord>(dependency.Descendants(child.Second()));
					phrase.Sort();
					premod.Add(phrase);
				}
			}
		...
		public virtual List<List<IndexedWord>> GetPostmodifiers()
		{
			...
			{
				string function = child.First().GetShortName();
				if (child.Second().Index() > headWord.Index() && !function.EndsWith("det") && !function.Equals("nummod") && !function.StartsWith("acl") && !function.StartsWith("advcl") && !function.Equals("punct") && !(function.Equals("case") && dependency.
		...
		public virtual bool IsRelativePronoun(Edu.Stanford.Nlp.Dcoref.Mention m)
		{
			return relativePronouns != null && relativePronouns.Contains(m);
		}

		public virtual bool IsRoleAppositive(Edu.Stanford.Nlp.Dcoref.Mention m, Dictionaries dict)
		{
		...
		public virtual bool IsDemonym(Edu.Stanford.Nlp.Dcoref.Mention m, Dictionaries dict)
		{
		...
		public virtual string GetRelation()
		{
			...
			if (!dependency.ContainsVertex(dependency.GetParent(headIndexedWord)))
			{
				return null;
			}
			GrammaticalRelation relation = dependency.Reln(dependency.GetParent(headIndexedWord), headIndexedWord);
			// adjunct relations
			if (relation != UniversalEnglishGrammaticalRelations.RelativeClauseModifier && relation != UniversalEnglishGrammaticalRelations.PossessionModifier && relation != UniversalEnglishGrammaticalRelations.NpAdverbialModifier && relation != UniversalEnglishGrammaticalRelations
				.Agent && (relation.ToString().StartsWith("nmod") || relation.ToString().StartsWith("acl") || relation.ToString().StartsWith("advcl") || relation == UniversalEnglishGrammaticalRelations.AdverbialModifier))
			{
				//do not match "acl:relcl"
				//do not match "nmod:poss"
				//do not match "nmod:npmod"
				//do not match "nmod:agent"
				//matches all regular nmod, nmods with prepositions in relation name, and "nmod:tmod"
				return "adjunct";
			}
			// subject relations
		...
		public virtual int GetModifiers(Dictionaries dict)
		{
			...
			int count = 0;
			IList<Pair<GrammaticalRelation, IndexedWord>> childPairs = dependency.ChildPairs(headIndexedWord);
			foreach (Pair<GrammaticalRelation, IndexedWord> childPair in childPairs)
			{
				...
				if ((gr == UniversalEnglishGrammaticalRelations.AdjectivalModifier || gr == UniversalEnglishGrammaticalRelations.RelativeClauseModifier || gr.ToString().StartsWith("nmod") || gr.ToString().StartsWith("acl") || gr.ToString().StartsWith("advcl"
					)) && !dict.determiners.Contains(word.Lemma()))
				{
					count++;
				}
				// add noun modifier when the mention isn't a NER
				if (nerString.Equals("O") && gr == UniversalEnglishGrammaticalRelations.CompoundModifier)
				{
					count++;
				}
			}
		...
		public virtual string GetQuantification(Dictionaries dict)
		{
			...
			ICollection<IndexedWord> quant = dependency.GetChildrenWithReln(headIndexedWord, UniversalEnglishGrammaticalRelations.Determiner);
			ICollection<IndexedWord> poss = dependency.GetChildrenWithReln(headIndexedWord, UniversalEnglishGrammaticalRelations.PossessionModifier);
			if (!quant.IsEmpty())
			{
			...
			else
			{
				...
				{
					quant = dependency.GetChildrenWithReln(headIndexedWord, UniversalEnglishGrammaticalRelations.NumericModifier);
					if (!quant.IsEmpty())
					{
						return "quantified";
					}
		...
		public virtual int GetNegation(Dictionaries dict)
		{
			...
			ICollection<IndexedWord> children = dependency.GetChildren(headIndexedWord);
			...
			// or has a sibling
			foreach (IndexedWord sibling in dependency.GetSiblings(headIndexedWord))
			{
				if (dict.negations.Contains(sibling.Lemma()) && !dependency.HasParentWithReln(headIndexedWord, UniversalEnglishGrammaticalRelations.NominalSubject))
				{
					return 1;
				}
			}
			// check the parent
			IList<Pair<GrammaticalRelation, IndexedWord>> parentPairs = dependency.ParentPairs(headIndexedWord);
		...
		public virtual int GetModal(Dictionaries dict)
		{
			...
			if (parent != null)
			{
				...
				IndexedWord child_1 = dependency.GetChildWithReln(parent, UniversalEnglishGrammaticalRelations.AuxModifier);
				if (!dependency.HasParentWithReln(headIndexedWord, UniversalEnglishGrammaticalRelations.NominalSubject) && child_1 != null && dict.modals.Contains(child_1.Lemma()))
				{
					return 1;
				}
			}
			// look at the path to root
			IList<IndexedWord> path = dependency.GetPathToRoot(headIndexedWord);
			if (path == null)
			{
				return 0;
			}
		...
		public virtual int GetReportEmbedding(Dictionaries dict)
		{
			...
			foreach (IndexedWord sibling in dependency.GetSiblings(headIndexedWord))
			{
				if (dict.reportVerb.Contains(sibling.Lemma()) && dependency.HasParentWithReln(sibling, UniversalEnglishGrammaticalRelations.AdvClauseModifier))
				{
			...
			if (dependency.HasParentWithReln(headIndexedWord, UniversalEnglishGrammaticalRelations.NominalSubject))
			{
				isSubject = true;
			}
			foreach (IndexedWord word in path)
			{
				...
				isSubject = dependency.HasParentWithReln(word, UniversalEnglishGrammaticalRelations.NominalSubject);
			}
			return 0;
		}
		...
		public virtual int GetCoordination()
		{
			...
			ICollection<GrammaticalRelation> relations = dependency.ChildRelns(headIndexedWord);
			...
			ICollection<GrammaticalRelation> parent_relations = dependency.Relns(headIndexedWord);
