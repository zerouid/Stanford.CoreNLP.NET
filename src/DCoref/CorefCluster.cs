...
namespace Edu.Stanford.Nlp.Dcoref
{
	...
	public class CorefCluster
	{
		...
		protected internal readonly ICollection<Mention> corefMentions;

		protected internal readonly int clusterID;

		protected internal readonly ICollection<Dictionaries.Number> numbers;

		protected internal readonly ICollection<Dictionaries.Gender> genders;

		protected internal readonly ICollection<Dictionaries.Animacy> animacies;

		protected internal readonly ICollection<string> nerStrings;

		protected internal readonly ICollection<string> heads;
		...
		/// </remarks>
		protected internal Mention representative;
		...
		public static void MergeClusters(Edu.Stanford.Nlp.Dcoref.CorefCluster to, Edu.Stanford.Nlp.Dcoref.CorefCluster from)
		{
			...
			SieveCoreferenceSystem.logger.Finer(string.Empty);
		}

		/// <summary>Print cluster information</summary>
		public virtual void PrintCorefCluster(Logger logger)
		{
			...
			foreach (Mention m_1 in forSortedPrint.Values)
			{
				...
				{
					logger.Finer(rep + "mention-> id:" + m_1.mentionID + "\toriginalRef: " + m_1.originalRef + "\t" + m_1.SpanToString() + "\tsentNum: " + m_1.sentNum + "\tstartIndex: " + m_1.startIndex + "\tType: " + m_1.mentionType + "\tNER: " + m_1.nerString
						);
				}
				else
				{
					logger.Finer(rep + "mention-> id:" + m_1.mentionID + "\toriginalClusterID: " + m_1.goldCorefClusterID + "\t" + m_1.SpanToString() + "\tsentNum: " + m_1.sentNum + "\tstartIndex: " + m_1.startIndex + "\toriginalRef: " + m_1.originalRef + "\tType: "
						 + m_1.mentionType + "\tNER: " + m_1.nerString);
				}
			}
		}
