...
namespace Edu.Stanford.Nlp.Dcoref
{
	...
	public class SpeakerInfo
	{
		...
		private ICollection<Mention> mentions = new LinkedHashSet<Mention>();

		private bool speakerIdIsNumber;

		private bool speakerIdIsAutoDetermined;

		private static readonly Pattern DefaultSpeakerPattern = Pattern.Compile("PER\\d+");

		protected internal static readonly Pattern WhitespacePattern = Pattern.Compile("\\s+|_+");
