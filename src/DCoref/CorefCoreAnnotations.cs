...
namespace Edu.Stanford.Nlp.Dcoref
{
	...
	public class CorefCoreAnnotations
	{
		...
		/// <summary>Destination of the coreference link for this word (if any).</summary>
		/// <remarks>
		...
		/// </remarks>
		[System.ObsoleteAttribute(@"This was an original dcoref annotation. You should now use CorefChainAnnotation")]
