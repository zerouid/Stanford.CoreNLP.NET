...
namespace Edu.Stanford.Nlp.Trees.International.Pennchinese
{
	...
	/// </author>
	[System.Serializable]
	public class UniversalChineseGrammaticalStructure : GrammaticalStructure
	{
		/// <summary>A logger for this class</summary>
		private static Redwood.RedwoodChannels log = Redwood.Channels(typeof(Edu.Stanford.Nlp.Trees.International.Pennchinese.UniversalChineseGrammaticalStructure));

		private static IHeadFinder shf = new UniversalChineseSemanticHeadFinder();
		...
		public UniversalChineseGrammaticalStructure(Tree t, IPredicate<string> puncFilter)
			: this(t, puncFilter, shf)
		{
		}

		public UniversalChineseGrammaticalStructure(Tree t, IHeadFinder hf)
			: this(t, null, hf)
		{
		}
		...
		{
			return ReadCoNLLXGrammaticalStructureCollection(fileName, UniversalChineseGrammaticalRelations.shortNameToGRel, new UniversalChineseGrammaticalStructure.FromDependenciesFactory());
		}

		public static Edu.Stanford.Nlp.Trees.International.Pennchinese.UniversalChineseGrammaticalStructure BuildCoNLLXGrammaticalStructure(IList<IList<string>> tokenFields)
		{
			return (Edu.Stanford.Nlp.Trees.International.Pennchinese.UniversalChineseGrammaticalStructure)BuildCoNLLXGrammaticalStructure(tokenFields, UniversalChineseGrammaticalRelations.shortNameToGRel, new UniversalChineseGrammaticalStructure.FromDependenciesFactory
				());
		}
