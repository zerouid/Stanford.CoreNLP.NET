...
namespace Edu.Stanford.Nlp.Trees.Tregex.Tsurgeon
{
	...
	internal class Token
	{
		...
		/// this field.
		/// </remarks>
		public Edu.Stanford.Nlp.Trees.Tregex.Tsurgeon.Token next;
		...
		/// </remarks>
		public Edu.Stanford.Nlp.Trees.Tregex.Tsurgeon.Token specialToken;
		...
		/// </remarks>
		public static Edu.Stanford.Nlp.Trees.Tregex.Tsurgeon.Token NewToken(int ofKind, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Edu.Stanford.Nlp.Trees.Tregex.Tsurgeon.Token(ofKind, image);
				}
			}
		}

		public static Edu.Stanford.Nlp.Trees.Tregex.Tsurgeon.Token NewToken(int ofKind)
		{
