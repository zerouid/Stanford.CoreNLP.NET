...
namespace Edu.Stanford.Nlp.Trees.Tregex
{
	...
	internal class Token
	{
		...
		/// this field.
		/// </remarks>
		public Edu.Stanford.Nlp.Trees.Tregex.Token next;
		...
		/// </remarks>
		public Edu.Stanford.Nlp.Trees.Tregex.Token specialToken;
		...
		/// </remarks>
		public static Edu.Stanford.Nlp.Trees.Tregex.Token NewToken(int ofKind, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Edu.Stanford.Nlp.Trees.Tregex.Token(ofKind, image);
				}
			}
		}

		public static Edu.Stanford.Nlp.Trees.Tregex.Token NewToken(int ofKind)
		{
