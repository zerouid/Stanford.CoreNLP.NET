...
namespace Edu.Stanford.Nlp.Ling.Tokensregex.Parser
{
	...
	internal class Token
	{
		...
		/// this field.
		/// </remarks>
		public Edu.Stanford.Nlp.Ling.Tokensregex.Parser.Token next;
		...
		/// </remarks>
		public Edu.Stanford.Nlp.Ling.Tokensregex.Parser.Token specialToken;
		...
		/// </remarks>
		public static Edu.Stanford.Nlp.Ling.Tokensregex.Parser.Token NewToken(int ofKind, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Edu.Stanford.Nlp.Ling.Tokensregex.Parser.Token(ofKind, image);
				}
			}
		}

		public static Edu.Stanford.Nlp.Ling.Tokensregex.Parser.Token NewToken(int ofKind)
		{
