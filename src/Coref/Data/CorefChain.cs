...
namespace Edu.Stanford.Nlp.Coref.Data
{
	...
	public class CorefChain
	{
		...
		public override bool Equals(object aThat)
		{
			...
			if (!(aThat is Edu.Stanford.Nlp.Coref.Data.CorefChain))
			{
				return false;
			}
			Edu.Stanford.Nlp.Coref.Data.CorefChain that = (Edu.Stanford.Nlp.Coref.Data.CorefChain)aThat;
		...
		{
			return mentionMap[new IntPair(sentenceNumber, headIndex)];
		}
		...
		public class CorefMentionComparator : IComparator<CorefChain.CorefMention>
		{
		...
		public class MentionComparator : IComparator<Mention>
		{
