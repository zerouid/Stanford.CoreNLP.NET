...
namespace Edu.Stanford.Nlp.Coref.Hybrid.Sieve
{
	public class DcorefSieveOptions
	{
		...
		public bool UseSpeakermatch;

		public bool UseChineseHeadMatch;
		...
		public override string ToString()
		{
			...
			if (UseSpeakermatch)
			{
				os.Append(", USE_SPEAKERMATCH");
			}
			if (UseChineseHeadMatch)
			{
				os.Append(", USE_CHINESE_HEAD_MATCH");
			}
			os.Append("}");
			return os.ToString();
		}
		...
		public DcorefSieveOptions()
		{
			...
			UseCorefDict = false;
			UseSpeakermatch = false;
			UseChineseHeadMatch = false;
		}
	}
}
